...
import AiringTodaySerialsPage, {
  getServerSideProps,
} from "@/pages/serials/airing-today";
...
describe("AiringTodaySerialsPage", () => {
  beforeEach(() => {
  ...
  it("Should render component without crashing", () => {
    withQueryClientProvider(<AiringTodaySerialsPage />);

    expect(screen.getByText(/AiringTodaySerialsPage/)).toBeInTheDocument();
  });
