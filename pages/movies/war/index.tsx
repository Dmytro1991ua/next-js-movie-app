...
const WarMoviesPage: NextPage = () => {
  ...
  const warMovies = useMemo(() => getMoviesOrSerialsPageData(data), [data]);
  const pageTitle = useMemo(
    () => getSeeMorePageTitle({ title: SliderTitle.WarMovies }),
    []
  );

  return <Cards cards={warMovies} route={AppRoutes.Movies} title={pageTitle} />;
};
